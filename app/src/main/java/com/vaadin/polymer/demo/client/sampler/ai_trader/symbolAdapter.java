...
public class symbolAdapter extends RecyclerView.Adapter<symbolAdapter.ViewHolder> {
    ...
    public symbolAdapter(String[] myDataset) {
        mDataset = myDataset;
    }
    ...
    @Override
    public symbolAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                   int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_trading_symbol, parent, false);
